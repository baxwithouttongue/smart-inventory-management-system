...
- Task 1: Smart Inventory Management System (Project Report, Python Files, CSV Files, README, USER GUIDE, Video Link)

- Task 2: Study Report on Min-Heap and Knapsack on Smart Inventory Management System (Study Report, Python Files, CSV Files, README, USER GUIDE, Video Link)
...
- Task 2: A New Data Structure (Heap) and A New Algorithm (Knapsack) Project
